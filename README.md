...
1. 1st Bug: In line 8 (formattedEmailAddress) is replacing all the characters in the email to "/" when what it should be doing is just replacing the dots as the example shows. Solution: replace the "." for "\\." 
